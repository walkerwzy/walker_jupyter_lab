...
class Dataset:
    def __init__(self, augment, image_size, provider, batch_size=None, max_stride=32):
        ...
        for item in self.provider.all_labeled_information:
            ...
            image_width, image_height = item[2]
            max_line = max(image_width, image_height)
            scale_width = image_size * image_width / max_line
            scale_height = image_size * image_height / max_line
            
            annotation_size = normalize_annotations[:, [2, 3]] * [scale_width, scale_height]
